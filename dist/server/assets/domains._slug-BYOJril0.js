import { s as fetchProjectsForDomain } from "./data-DheW3zCV.js";
import { t as Route } from "./domains._slug-CHLnMC9m.js";
...
import { ArrowLeft, ArrowUpRight, Check, ChevronLeft, ChevronRight, Search } from "lucide-react";
import { motion } from "framer-motion";
//#region src/routes/domains.$slug.tsx?tsr-split=component
...
function DomainDetail() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(Link, {
						...
						children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "size-4" }), " All Domains"]
					}), /* @__PURE__ */ jsxs("div", {
				...
				children: [
					projects.length > 0 && /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
							...
							children: [/* @__PURE__ */ jsx(Search, { className: "size-4 text-muted-foreground mr-3 shrink-0" }), /* @__PURE__ */ jsx("input", {
								value: q,
					...
					}) : filteredProjects.length === 0 ? /* @__PURE__ */ jsxs("div", {
						className: "border border-dashed border-border rounded-lg p-12 text-center text-muted-foreground bg-card",
						children: [/* @__PURE__ */ jsx("p", {
							className: "text-lg font-medium text-foreground",
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", { children: [
										...
										/* @__PURE__ */ jsx("div", {
											...
											children: p.technologies.slice(0, 4).map((tech) => /* @__PURE__ */ jsx("span", {
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												p.resourcesIncluded.slice(0, 4).map((res) => /* @__PURE__ */ jsxs("div", {
													className: "flex items-center gap-2 text-xs text-foreground/90",
													children: [/* @__PURE__ */ jsx(Check, { className: "size-3.5 text-primary shrink-0" }), /* @__PURE__ */ jsx("span", {
														className: "truncate",
														children: res
													})]
												}, res)),
												p.resourcesIncluded.length > 4 && /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
											...
											children: [/* @__PURE__ */ jsxs(Link, {
												...
												children: ["Details ", /* @__PURE__ */ jsx(ArrowUpRight, { className: "size-3" })]
											}), /* @__PURE__ */ jsx("button", {
			...
			/* @__PURE__ */ jsx(Footer, {}),
			selectedProject && /* @__PURE__ */ jsx(PurchaseModal, {
