import { f as API, o as fetchDomains, t as DOMAINS } from "./data-DheW3zCV.js";
...
function HomePage() {
	...
	const [matchingDomainIds, setMatchingDomainIds] = useState([]);
	useEffect(() => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			promo && !bannerDismissed && /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs(motion.div, {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-grid-pattern opacity-10 pointer-events-none" }),
						/* @__PURE__ */ jsx("div", { className: "absolute -right-32 -bottom-32 size-64 bg-primary/20 blur-3xl pointer-events-none" }),
						/* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsx(FeaturedDomains, {
				domains: filteredDomains,
				loading
			}),
			/* @__PURE__ */ jsx(ContactInfo, {}),
			/* @__PURE__ */ jsx(Footer, {}),
			showPopup && promo && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: Array.from({ length: 15 }).map((_, i) => /* @__PURE__ */ jsx(motion.div, {
						initial: {
							y: -20,
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "absolute -right-20 -top-20 size-60 rounded-full bg-primary/25 blur-3xl pointer-events-none" }),
						/* @__PURE__ */ jsx("div", { className: "absolute -left-20 -bottom-20 size-60 rounded-full bg-indigo-500/15 blur-3xl pointer-events-none" }),
						/* @__PURE__ */ jsx("button", {
							onClick: closePopup,
								...
								children: [/* @__PURE__ */ jsxs(motion.div, {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [
												/* @__PURE__ */ jsx("div", { className: "absolute inset-0 opacity-15 pointer-events-none bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-white/20 via-transparent to-transparent" }),
												/* @__PURE__ */ jsx("div", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								}), /* @__PURE__ */ jsx("span", { children: "Don't show again" })]
							})]
						})
					]
				})]
...
function Hero({ searchQuery, setSearchQuery }) {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "grain-bg absolute inset-0 opacity-40 pointer-events-none" }), /* @__PURE__ */ jsxs("div", {
...
function FeaturedDomains({ domains, loading }) {
	...
	return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx(SectionHeader, {
			...
			children: domains.map((d, i) => /* @__PURE__ */ jsx(DomainCard, {
				d,
				index: i
			}, d.id))
		})]
