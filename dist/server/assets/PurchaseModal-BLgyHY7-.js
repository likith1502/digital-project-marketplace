import { f as API, n as addPurchase } from "./data-DheW3zCV.js";
import { useEffect, useRef, useState } from "react";
import { useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { AlertCircle, Loader2, X } from "lucide-react";
import { AnimatePresence, motion } from "framer-motion";
//#region src/components/site/PurchaseModal.tsx
var log = (step, data) => {
		...
		children: /* @__PURE__ */ jsxs(motion.div, {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					err.submit && /* @__PURE__ */ jsxs(motion.div, {
						initial: {
							opacity: 0,
							y: -6
						},
						...
						children: [/* @__PURE__ */ jsx(AlertCircle, { className: "size-4 text-destructive shrink-0 mt-0.5" }), /* @__PURE__ */ jsx("div", {
							className: "text-sm text-destructive leading-snug",
							children: err.submit
						})]
					}),
					loading && statusMsg && /* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [loading ? /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }) : null, loading ? statusMsg || "Processing..." : "Pay & Download"]
						})]
					})
				]
			})]
